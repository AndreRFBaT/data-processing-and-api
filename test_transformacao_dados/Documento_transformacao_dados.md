# Tarefa de Transformação de Dados

## O objetivo desta tarefa é transformar os dados da coleta em um formato adequado para análise e visualização.

### Provas da tarefa e resultados:

1. Execução do arquivo `transformacao_dados.py`*

![alt text](/test_transformacao_dados/imagens_transf_dados/image.png)

![alt text](/test_transformacao_dados/imagens_transf_dados/image-1.png)

2. Arquivos transformados*

![alt text](/test_transformacao_dados/imagens_transf_dados/image-2.png)

### Script Python prara transformação de dados:
